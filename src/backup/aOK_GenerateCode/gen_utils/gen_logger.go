...
func Generate_LoggerContents() {
	sb := dir.FormStringDir(project.ProjectName, LoggerImports)

	logger_ := fmt.Sprintf(header, sb.String())
	dir.Create_Files(logger_, "logger.go")
